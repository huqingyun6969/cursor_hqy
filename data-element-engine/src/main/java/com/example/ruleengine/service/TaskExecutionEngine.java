...
import com.example.ruleengine.mapper.*;
...
public class TaskExecutionEngine {
    ...
    public ExecutionTask submitTask(TaskCreateDTO dto) {
        ...
        task.setTableName(dto.getTableName() != null ? dto.getTableName() : ds.getTableName());
    ...
    private long countRows(JdbcTemplate jdbc, ExecutionTask task, DataSourceConfig ds) {
        ...
        sql.append(task.getTableName() != null ? task.getTableName() : ds.getTableName());
    ...
    private List<Map<String, Object>> fetchDataBatch(JdbcTemplate jdbc, ExecutionTask task,
        ...
        sql.append(" FROM ").append(task.getTableName() != null ? task.getTableName() : ds.getTableName());
        appendWhereClause(sql, task);
